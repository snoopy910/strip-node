...
func TestSendAlgorandTransaction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			SerializedTxn:   "iaNhbXRko2ZlZc4AA5ngomZ2ZKNnZW6sdGVzdG5ldC12MS4womdoxCBIY7UYpLPITsgQ8i1PEIHLD3HwWaesIN7GL39w5Qk6IqJsdszIo3JjdsQgQEjO4wQHaHZFVdnfF+A6QnPDoQjsrcIMVeuSU4VISFmjc25kxCBASM7jBAdodkVV2d8X4DpCc8OhCOytwgxV65JThUhIWaR0eXBlo3BheQ==",
		...
		},
		{
			...
			IsError:         true,
			Error:           "failed to decode serialized transaction: illegal base64 data at input byte 8",
		},
		{
