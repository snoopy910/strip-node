...
import (
	...
	common "github.com/StripChain/strip-node/common"
...
func TestVerifySignatureSecp256k1Success(t *testing.T) {
	...
	valid, err := common.VerifySignature(publicKeyHex, common.SECP256K1_CURVE, message, signatureHex)
	if err != nil {
...
func TestVerifySignatureSecp256k1Fail(t *testing.T) {
	...
	valid, err := common.VerifySignature(publicKeyHex, common.SECP256K1_CURVE, message, invalidSignatureHex)
	if err != nil {
		t.Fatalf("Failed to verify signature: %v", err)
	}
